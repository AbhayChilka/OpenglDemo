...
void display(void)
{
	...
	glRotatef((GLfloat)shoulder, 0.0f, 0.0f, 1.0f); //bcz in glu library z is x axis
	...
	//pop the matrix to come back to that point wherearm ended by translation not by scale
	glPopMatrix();

	//do transformation for forearm 
	glTranslatef(1.0f, 0.0f, 0.0f);	
