...
void initialise(void)
{
	...
	loadGLTexture(texture_chechkboard);
...
*/
	...
	glGenTextures(1, &texture_chechkboard);

	glBindTexture(GL_TEXTURE_2D, texture_chechkboard);
...
void uninitialise(void)
{
	...
	if (texture_chechkboard)
	{
		glDeleteTextures(1, &texture_chechkboard);
		texture_chechkboard = 0;
	}
