...
GLfloat lightSpeclarZero[] = {1.0f, 0.0f, 0.0f, 1.0f};
...
GLfloat lightSpeclarOne[] = {0.0f, 0.0f, 1.0f, 1.0f};
...
void initialise(void)
{
	...
	glLightfv(GL_LIGHT0, GL_SPECULAR, lightSpeclarZero);
	...
	glLightfv(GL_LIGHT1, GL_SPECULAR, lightSpeclarOne);
