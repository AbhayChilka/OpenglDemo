...
mat4 orthographicProjetionMatrix;
...
int initialize(void)
{
	...
	//initialise
	orthographicProjetionMatrix = vmath::mat4::identity();
...
void resize(int width, int height)
{
	...
	if (width <= height)
	{
	orthographicProjetionMatrix = vmath :: ortho(-100.0f,    //left
					 							  100.0f,	//right
	...
	{
	orthographicProjetionMatrix = vmath::ortho(-100.0f * ((GLfloat)width / (GLfloat)height), //left
