...
static int year = 0, moon = 0, day = 0;
...
void display(void)
{
	...
	//transformation
	//sphere
	ModelStack.push(ModelStack.top() * vmath::translate(0.0f, 0.0f, -12.0f));  //pushmatrix(); glTranslate();
	...
	if (bLightingEnable == TRUE)
	{
		...
		glUniform3fv(ldUniform, 1, lightDefuse); // thogh array values are 4, we are using 3fv function purposly
	...
	glBindVertexArray(vao_sphere);
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, vbo_sphere_element); // bind to binding point or target

//	glDrawElements(GL_TRIANGLES, gNumElements, GL_UNSIGNED_SHORT, 0);

/*	ModelStack.push(ModelStack.top() * vmath::rotate((GLfloat)year, 0.0f, 1.0f, 0.0f) * vmath::translate(1.0f, 0.0f, 0.0f) * vmath::rotate((GLfloat)day, 0.0f, 1.0f, 0.0f)* vmath::scale(2.0f, 0.5f, 1.0f));
	glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
	glUniformMatrix4fv(modelViewMatrixUniform, 1, GL_FALSE, ModelStack.top());
	glDrawElements(GL_TRIANGLES, gNumElements, GL_UNSIGNED_SHORT, 0);
	ModelStack.pop();*/

	ModelStack.push(ModelStack.top() * vmath::rotate((GLfloat)year,  0.0f, 0.0f, 1.0f) * vmath::translate(1.0f, 0.0f, 0.0f)* vmath::scale(2.0f, 0.5f, 1.0f));
	glUniformMatrix4fv(modelViewMatrixUniform, 1, GL_FALSE, ModelStack.top());
	glDrawElements(GL_TRIANGLES, gNumElements, GL_UNSIGNED_SHORT, 0);
	glVertexAttrib4f(AMC_ATTRIBUTE_COLOR, 0.8f, 0.6f, 0.4f, 1.0f);
	ModelStack.pop();

	ModelStack.push(ModelStack.top() * vmath::rotate((GLfloat)moon,  0.0f, 0.0f, 1.0f) * vmath::translate(1.0f, 0.0f, 0.0f)* vmath::translate(1.5f, 0.0f, 0.0f) * vmath::scale(2.0f, 0.5f, 1.0f));
	glUniformMatrix4fv(modelViewMatrixUniform, 1, GL_FALSE, ModelStack.top());
	glDrawElements(GL_TRIANGLES, gNumElements, GL_UNSIGNED_SHORT, 0);
	ModelStack.pop();

	ModelStack.push(ModelStack.top() * vmath::rotate((GLfloat)moon,  0.0f, 0.0f, 1.0f) * vmath::translate(0.5f, 0.0f, 0.0f) * vmath::translate(1.5f, 0.0f, 0.0f)* vmath::translate(1.5f, 0.0f, 0.0f) * vmath::scale(2.0f, 0.5f, 1.0f));
	glUniformMatrix4fv(modelViewMatrixUniform, 1, GL_FALSE, ModelStack.top());
	glDrawElements(GL_TRIANGLES, gNumElements, GL_UNSIGNED_SHORT, 0);
	ModelStack.pop();
