...
void draw(void)
{
	...
	//transformation
	//sphere
	ModelStack.push(ModelStack.top() * vmath::translate(0.0f, 0.0f, -5.0f));  //pushmatrix(); glTranslate();
	...
	glVertexAttrib4f(AMC_ATTRIBUTE_COLOR, 1.0f, 0.5f, 0.0f, 1.0f);
	glUniformMatrix4fv(modelViewMatrixUniform, 1, GL_FALSE, ModelStack.top());
	glDrawElements(GL_TRIANGLES, gNumElements, GL_UNSIGNED_SHORT, 0);

	//earth
	ModelStack.push(ModelStack.top() * vmath::rotate((GLfloat)year, 0.0f, 1.0f, 0.0f) * vmath::translate(1.0f, 0.0f, 0.0f) * vmath::rotate((GLfloat)day, 0.0f, 1.0f, 0.0f)* vmath::scale(0.5f, 0.5f, 0.5f));
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glVertexAttrib4f(AMC_ATTRIBUTE_COLOR, 0.3f, 0.4f, 0.8f, 1.0f);
	glUniformMatrix4fv(modelViewMatrixUniform, 1, GL_FALSE, ModelStack.top());
	glDrawElements(GL_TRIANGLES, gNumElements, GL_UNSIGNED_SHORT, 0);

	///moon
	ModelStack.push(ModelStack.top() * vmath::rotate((GLfloat)moon, 0.0f, 1.0f, 0.0f) * vmath::translate(1.0f, 0.0f, 0.0f) * vmath::scale(0.3f, 0.3f, 0.3f));
	glVertexAttrib4f(AMC_ATTRIBUTE_COLOR, 0.8f, 0.8f, 0.8f, 1.0f);	
	glUniformMatrix4fv(modelViewMatrixUniform, 1, GL_FALSE, ModelStack.top());
	glDrawElements(GL_TRIANGLES, gNumElements, GL_UNSIGNED_SHORT, 0);
	ModelStack.pop();
	ModelStack.pop();
