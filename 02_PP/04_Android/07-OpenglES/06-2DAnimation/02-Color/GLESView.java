package com.two2dshapescolorrotate.window;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener
{
    ...
    private float angle_trinagle = 0.0f;
    ...
    private void initialize(GL10 gl)
    {
       ...
       //triangle
        ...
        //VBO for color
        byteBuffer = ByteBuffer.allocateDirect(traingle_color.length * 4);
        byteBuffer.order(ByteOrder.nativeOrder());
        FloatBuffer ColorBuffer = byteBuffer.asFloatBuffer();
        ColorBuffer.put(traingle_color);
        ColorBuffer.position(0);
 
        GLES32.glGenBuffers(1, vbo_color_triangle, 0);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vbo_color_triangle[0]);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, traingle_color.length * 4, ColorBuffer, GLES32.GL_STATIC_DRAW);
    ...
    private void display()
    {
        ...
        Matrix.rotateM(modelViewMatrix, 0, angle_trinagle, 0.0f, 1.0f, 0.0f);
    ...
    private void update()
    {
        angle_trinagle = angle_trinagle + 0.5f;
        if (angle_trinagle >= 360.0f)
        {
            angle_trinagle = angle_trinagle - 360.0f;
        }
