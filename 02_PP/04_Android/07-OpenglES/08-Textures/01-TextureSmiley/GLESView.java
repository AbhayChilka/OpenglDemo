package com.texturesmiley.window;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnDoubleTapListener, OnGestureListener
{
    ...
    private void initialize(GL10 gl)
    {
    	...
    	final float square_texcoord[] = new float[]
									 {
										1.0f, 1.0f,
										0.0f, 1.0f,
										0.0f, 0.0f,
        ...
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, square_texcoord.length * 4, coordBuffer, GLES32.GL_STATIC_DRAW);
